      ...
      child: Row(children: [
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text('invite&getRewards'.tr,style: textSemiBold.copyWith(color: Get.isDarkMode ? Theme.of(context).textTheme.bodyMedium!.color!.withOpacity(0.9) : null)),
            const SizedBox(height: Dimensions.paddingSizeSmall),

            Text('share_code_with_your_friends'.tr,style: textRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall,color: Get.isDarkMode ? Theme.of(context).textTheme.bodyMedium!.color!.withOpacity(0.8) : null)),
            const SizedBox(height: Dimensions.paddingSizeSmall),
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Center(child: Text('invite_friends'.tr,
                    style: textRegular.copyWith(color: Get.isDarkMode ? Theme.of(context).textTheme.bodyMedium!.color!.withOpacity(0.9) : Theme.of(context).cardColor, fontSize: Dimensions.fontSizeSmall),
                  )),
                ),
              );
            })
